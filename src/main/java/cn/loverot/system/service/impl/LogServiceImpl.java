...
import cn.loverot.system.entity.SystemLog;
import cn.loverot.system.entity.User;
import cn.loverot.system.mapper.LogMapper;
...
public class LogServiceImpl extends ServiceImpl<LogMapper, SystemLog> implements ILogService {
    ...
    public IPage<SystemLog> findLogs(SystemLog systemLog, QueryRequest request) {
        ...
        SortUtil.handlePageSort(request, page, "createTime", Const.ORDER_DESC, true);
